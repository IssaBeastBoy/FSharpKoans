...
module ``08: The Good Kind of Discrimination`` = 
    ...
    let ``04 A discriminated union can refer to itself (i.e., it can be recursive).`` () =
        ...
        let a1 = BinaryTree.Node("",BinaryTree.Empty,BinaryTree.Empty)
        let a2 = BinaryTree.Node("",a1,BinaryTree.Empty)
        let a3 = BinaryTree.Node("",a2,BinaryTree.Empty)
        let a= BinaryTree.Node("",a3,BinaryTree.Empty)// <-- you may want to spread this over multiple lines and/or let-bindings ...!
